...
public class LoginFragment extends AppCompatActivity {
    ...
    private String email_facebbok;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.fragment_login_page_layout);
            mContext =this;
            Toolbar myToolbar = (Toolbar) findViewById(R.id.toolbar_id_forget_password_layout);
            myToolbar.setTitle("Forget Password");
            ...
            forget_button.setOnClickListener(new View.OnClickListener() {
                ...
                /*Fragment fr = new ForgetPasswordActivity();
