...
// Checking for first time launch - before calling setContentView()
        ...
        if (!prefs.isFirstTimeLaunch()) {
            ...
            mContext.startActivity(new Intent(MainActivity.this, HomeActivity.class));
        }
...
// add few more layouts if you want
        layouts = new int[]{
                R.layout.fragment_easy_to_manage,
                R.layout.fragment_my_profile,
                R.layout.fragment_getting_start,
                R.layout.hello_there_screen_asking_page,
        R.layout.fragment_login_page_layout};
// adding bottom dots
        addBottomDots(0);
// making notification bar transparent
