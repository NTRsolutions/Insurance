...
public class MyPolicyItemListAdapter  extends RecyclerView.Adapter<PolicyItemListAdapter.MyViewHolder> {

    private List<PolicyCategory> pList;
    Context context;
    String title;

    public MyPolicyItemListAdapter (Context mContext, List<PolicyCategory> moviesList, String title) {
        context = mContext;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            policy_item_image = (ImageView) view.findViewById(R.id.item_image_my_policy);
    ...
    @Override
    public PolicyItemListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.my_policy_list_item, parent, false);

        return new PolicyItemListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(PolicyItemListAdapter.MyViewHolder holder, final int position) {
