...
public class HomePageAdapter extends BaseAdapter {
    ...
    public HomePageAdapter(Context c,String[] web,int[] Imageid ) {
        mContext = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            grid = inflater.inflate(R.layout.home_grid_item_layout, null);
            TextView textView = (TextView) grid.findViewById(R.id.grid_item_name_title);
